...
task :submodule do
  sh 'git submodule update --init' unless File.exist?('foundation-datetimepicker/README.md')
end
...
task javascripts: :submodule do
  ...
  FileUtils.cp_r Dir["foundation-datetimepicker/src/js/*"], "vendor/assets/javascripts"
end
